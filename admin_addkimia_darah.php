                   ...
                   <!-- Begin Page Content -->
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-2">
                            <h1 class="h3 mb-0 text-gray-800">Input Hasil Lab Pemeriksaan Kimia Klinik</h1>
                        </div>
                        ...
                        <!--Awal Form-->
                        <form class="control-user"  action="admin_addkimia_darah_pcs.php?id_hasil=<?php echo"$id_hasil";?>" method="post">
                            ...
                            <div class="card-body shadow mb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <input type="text" class="form-control form-control-user" name="gl_sewaktu">
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <input type="text" class="form-control form-control-user" name="gl_puasa">
                                    </div>
                                    <label class="col-sm-3 col-form-label">(mg/dL)</label>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <input type="text" class="form-control form-control-user" name="gl_pp">
                                    </div>
                                    <label class="col-sm-3 col-form-label">(mg/dL)</label>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <input type="text" class="form-control form-control-user" name="cholesterol">
                                    </div>
                                    <label class="col-sm-3 col-form-label">(mg/dL)</label>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <input type="text" class="form-control form-control-user" name="hdl">
                                    </div>
                                    <label class="col-sm-3 col-form-label">(mg/dL)</label>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <input type="text" class="form-control form-control-user" name="ldl">
                                    </div>
                                    <label class="col-sm-3 col-form-label">(mg/dL)</label>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <input type="text" class="form-control form-control-user" name="trigliserida">
                                    </div>
                                    <label class="col-sm-3 col-form-label">(mg/dL)</label>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <input type="text" class="form-control form-control-user" name="sgot">
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <input type="text" class="form-control form-control-user" name="sgpt">
                                    </div>
                                    <label class="col-sm-3 col-form-label">(U/L)</label>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <input type="text" class="form-control form-control-user" name="ureum">
                                    </div>
                                    <label class="col-sm-3 col-form-label">(mg/dL)</label>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <input type="text" class="form-control form-control-user" name="creatinin">
                                    </div>
                                    <label class="col-sm-3 col-form-label">(mg/dL)</label>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <input type="text" class="form-control form-control-user" name="asam_urat">
                                    </div>
                                    <label class="col-sm-3 col-form-label">(mg/dL)</label>
                                </div>
