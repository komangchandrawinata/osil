...
if (isset($_GET['edit'])) {
  $id = $_GET['edit'];
  $sql_edit = "SELECT * FROM reagen WHERE id = $id";
...
if (isset($_GET['hapus'])) {
  ...
  $sql_delete = "DELETE FROM reagen WHERE id = $id";
                    ...
                    <a class="nav-link" href="admindashboard.php">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h3 mb-0 text-gray-800">Data Reagen</h1>
                                <!-- <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Tambah</button> -->
                                <a href="reagen_form_add.php" class="btn btn-primary">Tambah</a>
                            </div>
                            <br>
