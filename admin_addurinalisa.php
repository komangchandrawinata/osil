...
if(empty($dt['urinalisa'])){

    header('Location: admin_addbakteriologi.php?id_hasil='.$id_hasil);
}
                   ...
                   <!-- Begin Page Content -->
                    <div class="container-fluid">
                       ...
                       <div class="d-sm-flex align-items-center justify-content-between mb-2">
                        <h1 class="h3 mb-0 text-gray-800">Input Hasil Lab Pemeriksaan Urinalisa</h1>
                    </div>
                    ...
                    <!--Awal Form-->
                    <form class="control-user"  action="admin_addurinalisa_pcs.php?id_hasil=<?php echo"$id_hasil";?>" method="post">

                        <div class="card-body shadow mb-4">

                            <h6 class="m-0 font-weight-bold text-gray-600">Makroskopis</h6>
                        <br>

                            <div class="row">
                                <label class="col-sm-3 col-form-label">Warna</label>
                                <div class="form-group col-lg-6">
                                    <input type="text" class="form-control form-control-user" name="warna">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                   <input type="text" class="form-control form-control-user" name="kejernihan">
                           ...
                           <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                <input type="text" class="form-control form-control-user" name="leukosit_u">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                <input type="text" class="form-control form-control-user" name="keton">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                <input type="text" class="form-control form-control-user" name="nitrit">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                <input type="text" class="form-control form-control-user" name="urobilinogen">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                <input type="text" class="form-control form-control-user" name="bilirubin">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                <input type="text" class="form-control form-control-user" name="protein">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                <input type="text" class="form-control form-control-user" name="glukosa_r">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                <input type="text" class="form-control form-control-user" name="berat_jenis">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                <input type="text" class="form-control form-control-user" name="ph">
                            </div>
                        ...
                        <div class="row">
                            <label class="col-sm-3 col-form-label">Leukosit</label>
                            <div class="form-group col-lg-6">
                                <input type="text" class="form-control form-control-user" name="leukosit_s">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                <input type="text" class="form-control form-control-user" name="eritrosit_s">
                            </div>
                            <label class="col-sm-3 col-form-label">(/LPB)</label>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                <input type="text" class="form-control form-control-user" name="epitel">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                <input type="text" class="form-control form-control-user" name="kristal">
                            </div>
                            <label class="col-sm-3 col-form-label">(/LPK)</label>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                <input type="text" class="form-control form-control-user" name="silinder">
                            </div>
                            <label class="col-sm-3 col-form-label">(/LPK)</label>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                <input type="text" class="form-control form-control-user" name="bakteri">
                            </div>
                        </div>
