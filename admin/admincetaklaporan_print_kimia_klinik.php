...
$qr_he = "SELECT tgl_hasil,no_rm,COUNT(no_rm) as norm,SUM(kimia_klinik) as kim FROM hasil WHERE tgl_hasil BETWEEN '$tgl_awal' AND '$tgl_akhir' AND kimia_klinik = '1' GROUP BY tgl_hasil,no_rm ORDER BY tgl_hasil,no_rm ASC";
...
//Rekap Hasil lab
$qr = "SELECT * FROM hasil WHERE tgl_hasil BETWEEN '$tgl_awal' AND '$tgl_akhir' AND kimia_klinik = '1'";
