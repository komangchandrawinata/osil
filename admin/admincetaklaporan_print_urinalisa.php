...
$qr_he = "SELECT tgl_hasil,no_rm,COUNT(no_rm) as norm,SUM(urinalisa) as urin FROM hasil WHERE tgl_hasil BETWEEN '$tgl_awal' AND '$tgl_akhir' AND urinalisa = '1' GROUP BY tgl_hasil,no_rm ORDER BY tgl_hasil,no_rm ASC";
...
//Rekap Hasil lab
$qr = "SELECT * FROM hasil WHERE tgl_hasil BETWEEN '$tgl_awal' AND '$tgl_akhir' AND urinalisa = '1'";
