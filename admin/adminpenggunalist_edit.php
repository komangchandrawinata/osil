...
if(isset($_POST['update'])) {
    ...
    if (empty($password)) {
      ...
      window.location='adminpenggunalist_edit.php?id_pengguna=1'";
      echo "</script>";
  }else{


      $sql= "UPDATE pengguna SET username='$username',petugas_lab='$petugas_lab',password='$password' WHERE id_pengguna=$id_pengguna";
                    ...
                    <a class="nav-link" href="adminpenggunalist.php">
                        ...
                        <!-- List Data Pasien -->
                            ...
                            <div class="container-fluid">
                                ...
                                <form action="adminpenggunalist_edit.php" method="post">
                                    <!-- DataTales Example -->
                                                 ...
                                                 <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="odd">
                                                            ...
                                                            <td style="width: 80%"><input type="text" name="username" class="form-control form-control-user" value="<?php echo $userpengguna?>"></td>

                                                        </tr>
                                                        <tr class="odd">
                                                            <td style="width: 20%">Penanggung Jawab</td>
                                                            <td style="width: 80%"><input type="text" name="petugas_lab" class="form-control form-control-user" value="<?php echo $petugas_lab?>"></td>
                                                        ...
                                                        <tr class="odd">
                                                            ...
                                                            <td style="width: 80%"><input type="password" name="password" class="form-control form-control-user" value="<?php echo $password?>"></td>
