                        ...
                        <!-- List Data Pasien -->
                            <li class="nav-item">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <form action="adminpenggunalist_admin.php" method="post">
                                        <!-- DataTales Example -->
                                                ...
                                                <div class="table-responsive">
                                                   <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                                     ...
                                                     <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                                        ...
                                                        <tr role="row">
                                                            <th class="sorting sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="2" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 100%;">Password Baru</th>

                                                        </tr>


                                                        <tr class="odd">
                                                            <td style="width: 90%"> <input type="password" name="password" class="form-control form-control-user"
                                                                id="exampleInputPassword" placeholder="Password" ></td>
