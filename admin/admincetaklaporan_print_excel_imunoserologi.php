...
if(isset($_POST['cetak'])) {
    ...
    header("Content-Disposition: attachment; filename=Laporan Rekapitulasi Hasil Laboratorium Pemeriksaan Imunoserologi Periode $tgl_awal _ $tgl_akhir.xls");
...
//Semua Kategori
    ...
    $qr_h = "SELECT tgl_hasil,no_rm,kode_lab,COUNT(no_rm) as norm,SUM(imunoserologi) as imun FROM hasil WHERE kode_lab = '$kode_lab' AND tgl_hasil BETWEEN '$tgl_awal' AND '$tgl_akhir' AND imunoserologi = '1' GROUP BY tgl_hasil,no_rm ORDER BY tgl_hasil,no_rm ASC";
