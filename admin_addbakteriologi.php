...
if(empty($dt['bakteriologi'])){

    header('Location: admin_addserologi.php?id_hasil='.$id_hasil);
}
                ...
                <li class="nav-item">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-2">
                            <h1 class="h3 mb-0 text-gray-800">Input Hasil Lab Pemeriksaan Bakteriologi / Parasitologi</h1>
                        </div>
                        ...
                        if($dt['imunoserologi']!="")
                        {
                            ...
                            <div class="card shadow mb-1">
                                ...
                                if(isset($dt_u)){
                                    ...
                                    ?>
                                    <div class="card-body  d-block card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-gray-600">IMUNOSEROLOG</h6>
                        ...
                        <div class="card-body shadow mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                    <input type="text" class="form-control form-control-user" name="m_tbc">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                    <input type="text" class="form-control form-control-user" name="tcm_tbc">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control form-control-user" name="gonorhae">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control form-control-user" name="malaria">
