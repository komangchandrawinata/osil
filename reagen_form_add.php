...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO reagen (nama, jumlah, tanggal_input, tanggal_expired, keterangan) 
            VALUES ('$nama', '$jumlah', '$tanggal_input', '$tanggal_expired', '$keterangan')";

    if ($connect->query($sql) === TRUE) {
        echo "Data berhasil disimpan";
        header("Location: proses_tambah_reagen.php");
    } else {
                    ...
                    <a class="nav-link" href="admindashboard.php">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h3 mb-0 text-gray-800">Input Data Reagen</h1>
                            </div>
                            <br>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                   <form class="control-user"  action="reagen_form_add.php" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-6">
                                            <input type="date" class="form-control form-control-user" id="tanggal_input" name="tanggal_input">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-6">
                                            <input type="date" class="form-control form-control-user" id="tanggal_expired" name="tanggal_expired">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-6">
                                            <textarea type="text" class="form-control form-control-user" id="keterangan" name="keterangan"> </textarea>
                                        </div>
                                    </div>
