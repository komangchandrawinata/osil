...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "SELECT * FROM reagen WHERE id = $id";
                    ...
                    <a class="nav-link" href="admindashboard.php">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h3 mb-0 text-gray-800">Perbarui Data Reagen</h1>
                            </div>
                            <br>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                   <form class="control-user"  action="reagen_form_edit.php" method="post">
