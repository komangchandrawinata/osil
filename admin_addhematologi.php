...
if(empty($dt['hematologi'])){

    header('Location: admin_addurinalisa.php?id_hasil='.$id_hasil);
}
            ...
            <!-- Menus -->
                ...
                <li class="nav-item">
                   ...
                   <!-- Begin Page Content -->
                    <div class="container-fluid">
                        ...
                        if($dt['urinalisa']!="")
                        {
                            ...
                            <div class="card shadow mb-1">
                                ...
                                $dt_u = mysqli_fetch_assoc($query_u);
                        ...
                        if($dt['bakteriologi']!="")
                        {
                            ...
                            <div class="card shadow mb-1">
                                <?php
                                $sql_b= "SELECT * FROM bakteriologi WHERE id_hasil=$id_hasil";

                                $query_b = mysqli_query($connect,$sql_b);
                                $dt_b = mysqli_fetch_assoc($query_b);
                        ...
                        if($dt['imunoserologi']!="")
                        {
                            ...
                            <div class="card shadow mb-1">
                                <?php
                                $sql_i= "SELECT * FROM imunoserologi WHERE id_hasil=$id_hasil";

                                $query_i = mysqli_query($connect,$sql_i);
                                $dt_i = mysqli_fetch_assoc($query_i);
                        ...
                        if($dt['kimia_klinik']!="")
                        {
                            ...
                            <div class="card shadow mb-1">
                                <?php
                                $sql_k= "SELECT * FROM kimia_klinik WHERE id_hasil=$id_hasil";

                                $query_k = mysqli_query($connect,$sql_k);
                                $dt_k = mysqli_fetch_assoc($query_k);
                    ...
                    <!--Awal Form-->
                    <form class="control-user"  action="admin_addhematologi_pcs.php?id_hasil=<?php echo"$id_hasil";?>" method="post">
