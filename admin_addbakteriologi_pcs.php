...
if(isset($_POST['submit'])) {
    ...
    $id_hasil = $_POST['id_hasil'];
     ...
     $m_tbc = $_POST['m_tbc'];
    $tcm_tbc = $_POST['tcm_tbc'];
    $gonorhae = $_POST['gonorhae'];
    
    $malaria = $_POST['malaria'];



    $sq_ba= "INSERT INTO bakteriologi (
    id_bakteriologi,m_tbc,tcm_tbc,gonorhae,malaria,id_hasil)
    VALUES
    ('','$m_tbc','$tcm_tbc','$gonorhae','$malaria','$id_hasil')";
    ...
    if($qry_ba){
        ...
        echo "<script language=\"Javascript\">\n";
        echo "alert('Data Hasil Lab Pemeriksaan Bakteriologi / Parasitologi Berhasil ditambahkan');";
        echo "</script>";
