					...
					<!-- Begin Page Content -->
						<div class="container-fluid">
							...
							<div class="d-sm-flex align-items-center justify-content-between mb-4">
								<h1 class="h3 mb-0 text-gray-800">Tambah Hasil Lab</h1>
							</div>
							...
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									...
									<form class="control-user"  action="admin_addhasil_pcs.php?no_rm=<?php echo"$no_rm";?>" method="post">
										...
										Pilih jenis pemeriksaan : <br>
										<input  type="checkbox" name="hematologi" value="1"> Hematologi<br>
										<input type="checkbox" name="urinalisa" value="1"> Urinalisa<br>
										<input type="checkbox" name="bakteriologi" value="1"> Bakteriologi/Parasitologi<br>
										<input type="checkbox" name="imunoserologi" value="1"> Imunoserologi<br>
										<input type="checkbox" name="kimia_klinik" value="1"> Kimia Klinik<br>    
										<br>
