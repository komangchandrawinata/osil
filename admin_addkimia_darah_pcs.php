...
if(isset($_POST['submit'])) {
    ...
    $sq_kd= "INSERT INTO kimia_klinik (
        id_kd,gl_sewaktu,gl_puasa,gl_pp,cholesterol,hdl,ldl,trigliserida,sgot,sgpt,ureum,creatinin,asam_urat,id_hasil)
    VALUES
    ('','$gl_sewaktu','$gl_puasa','$gl_pp','$cholesterol','$hdl','$ldl','$trigliserida','$sgot','$sgpt','$ureum','$creatinin','$asam_urat','$id_hasil')";
    ...
    if($qry_kd){
        ...
        echo "<script language=\"Javascript\">\n";
        echo "alert('Data Hasil Lab Pemeriksaan Kimia Klinik Hasil Berhasil ditambahkan');";
        echo "</script>";
