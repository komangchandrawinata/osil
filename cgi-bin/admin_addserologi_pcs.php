...
if(isset($_POST['submit'])) {
    ...
    $tes_kehamilan = $_POST['tes_kehamilan'];
    $ig_g = $_POST['ig_g'];
    $ig_m = $_POST['ig_m'];
    $hbsag = $_POST['hbsag'];
    $hiv = $_POST['hiv'];
    ...
    $sq_se= "INSERT INTO serologi (
        id_serologi,tes_kehamilan,ig_g,ig_m,hbsag,hiv,rdt_syphilis,rpr,hcv,gol_darah,s_thiphi_o,s_parathipy_ao,s_parathipy_bo,s_thiphi_h,igg,igm,agcovid,tifoid,id_hasil)
    VALUES
    ('','$tes_kehamilan','$ig_g','$ig_m','$hbsag','$hiv','$rdt_syphilis','$rpr','$hcv','$gol_darah','$s_thiphi_o','$s_parathipy_ao','$s_parathipy_bo','$s_thiphi_h','$igg','$igm','$agcovid','$tifoid','$id_hasil')";
    ...
    if($qry_se){
        ...
        echo "<script language=\"Javascript\">\n";
        echo "alert('Data Hasil Lab Pemeriksaan Serologi / Imunologi Berhasil ditambahkan');";
        echo "</script>";
