                    ...
                    <li class="nav-item">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h3 mb-0 text-gray-800">List Data Lab</h1>
                            </div>
                            <br>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="get" action="adminhasillist.php">
                                        <div class="row">
                                            <div class="col-sm-12 col-md-3">
                                                <input type="text" class="form-control form-control-sm" placeholder="Ketik Nama di Sini" aria-controls="dataTable" name="cari">
                                            </div>
                                     ...
                                     <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                        <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                            ...
                                            <tr role="row">
                                               ...
                                               <th class="sorting sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 20%;">No RM
                                               </th>
                                               <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 70%;">Nama Lengkap
                                               </th>
                                           ...
                                           if(isset($_GET['cari'])){
                                            ...
                                            $sql = mysqli_query($connect,"SELECT * FROM pasien WHERE kode_lab ='$kode_lab' AND nama_pasien LIKE '%".$cari."%' ");
                                        ...
                                        while ($data = mysqli_fetch_assoc($sql)) {
                                            ...
                                            <tr class="odd">
                                                ...
                                                <td><a href="adminhasillist_view.php?no_rm=<?php echo"$data[no_rm]";?>"><button type="submit"
