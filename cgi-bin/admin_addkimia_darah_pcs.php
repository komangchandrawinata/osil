...
if(isset($_POST['submit'])) {
    ...
    $gl_puasa = $_POST['gl_puasa'];
    $gl_pp = $_POST['gl_pp'];
    $gl_sewaktu = $_POST['gl_sewaktu'];
    $cholesterol = $_POST['cholesterol'];
    $asam_urat = $_POST['asam_urat'];
    $trigliserida = $_POST['trigliserida'];
    $ureum = $_POST['ureum'];
    $creatinin = $_POST['creatinin'];
    $sgot = $_POST['sgot'];
    $sgpt = $_POST['sgpt'];



    $sq_kd= "INSERT INTO kimia_darah (
        id_kd,gl_puasa,gl_pp,gl_sewaktu,cholesterol,asam_urat,trigliserida,ureum,creatinin,sgot,sgpt,id_hasil)
    VALUES
    ('','$gl_puasa','$gl_pp','$gl_sewaktu','$cholesterol','$asam_urat','$trigliserida','$ureum','$creatinin','$sgot','$sgpt','$id_hasil')";
    ...
    if($qry_kd){
        ...
        echo "<script language=\"Javascript\">\n";
        echo "alert('Data Hasil Lab Pemeriksaan Kimia Hasil Berhasil ditambahkan');";
        echo "</script>";
