                ...
                <li class="nav-item">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-2">
                            <h1 class="h3 mb-0 text-gray-800">Input Hasil Lab Pemeriksaan Serologi / Imunologi <?php echo $nama_pasien; ?></h1>
                        </div>
                            ...
                            <div class="card-body shadow mb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select class="form-control form-control-user" name="tes_kehamilan">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select class="form-control form-control-user" name="ig_g">
                                            <option value="-">--Klik untuk memilih--</option>
                                            <option value="Negatif">Negatif</option>
                                            <option value="Positif">Positif</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select class="form-control form-control-user" name="ig_m">
                                            <option value="-">--Klik untuk memilih--</option>
                                            <option value="Negatif">Negatif</option>
                                            <option value="Positif">Positif</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select class="form-control form-control-user" name="hbsag">
                                            <option value="-">--Klik untuk memilih--</option>
                                            <option value="Negatif">Negatif</option>
                                            <option value="Positif">Positif</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select class="form-control form-control-user" name="hiv">
                                            <option value="-">--Klik untuk memilih--</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select class="form-control form-control-user" name="rdt_syphilis">
                                            <option value="-">--Klik untuk memilih--</option>
                                            <option value="Negatif">Negatif</option>
                                            <option value="Positif">Positif</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select class="form-control form-control-user" name="rpr">
                                            <option value="-">--Klik untuk memilih--</option>
                                            <option value="Negatif">Negatif</option>
                                            <option value="Positif">Positif</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select class="form-control form-control-user" name="hcv">
                                            <option value="-">--Klik untuk memilih--</option>
                                            <option value="Negatif">Negatif</option>
                                            <option value="Positif">Positif</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select class="form-control form-control-user" name="s_thiphi_o">
                                            <option value="-">--Klik untuk memilih--</option>
                                            <option value="Negatif">Negatif</option>
                                            <option value="Positif">Positif</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select class="form-control form-control-user" name="s_parathipy_ao">
                                            <option  value="-">--Klik untuk memilih--</option>
                                            <option value="Negatif">Negatif</option>
                                            <option value="Positif">Positif</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select class="form-control form-control-user" name="s_parathipy_bo">
                                            <option value="-">--Klik untuk memilih--</option>
                                            <option value="Negatif">Negatif</option>
                                            <option value="Positif">Positif</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select class="form-control form-control-user" name="s_thiphi_h">
                                            <option value="-">--Klik untuk memilih--</option>
                                            <option value="Negatif">Negatif</option>
                                            <option value="Positif">Positif</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select class="form-control form-control-user" name="igg">
                                            <option value="-">--Klik untuk memilih--</option>
                                            <option value="Non Reaktif">Non Reaktif</option>
                                            <option value="Reaktif">Reaktif</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select class="form-control form-control-user" name="igm">
                                            <option value="-">--Klik untuk memilih--</option>
                                            <option value="Non Reaktif">Non Reaktif</option>
                                            <option value="Reaktif">Reaktif</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select class="form-control form-control-user" name="agcovid">
                                            <option value="-">--Klik untuk memilih--</option>
                                            <option value="Non Reaktif">Non Reaktif</option>
                                            <option value="Reaktif">Reaktif</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select class="form-control form-control-user" name="tifoid">
                                            <option value="-">--Klik untuk memilih--</option>
                                            <option value="Negatif">Negatif</option>
                                            <option value="Positif">Positif</option>
                                        </select>
