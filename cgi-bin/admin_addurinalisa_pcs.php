...
if(isset($_POST['submit'])) {
    ...
    $leukosit_u = $_POST['leukosit_u'];
    $keton = $_POST['keton'];
    $nitrit = $_POST['nitrit'];
    $urobilinogen = $_POST['urobilinogen'];
    $bilirubin = $_POST['bilirubin'];
    $protein = $_POST['protein'];
    $glukosa_r = $_POST['glukosa_r'];
    $berat_jenis = $_POST['berat_jenis'];
    $ph = $_POST['ph'];
    $leukosit_s = $_POST['leukosit_s'];
    $eritrosit_s = $_POST['eritrosit_s'];
    $epitel = $_POST['epitel'];



    $sq_ur= "INSERT INTO urinalisa (
        id_urinalisa,warna,kejernihan,leukosit_u,keton,nitrit,urobilinogen,bilirubin,protein,glukosa_r,berat_jenis,ph,leukosit_s,eritrosit_s,epitel,id_hasil)
    VALUES
    ('','$warna','$kejernihan','$leukosit_u','$keton','$nitrit','$urobilinogen','$bilirubin','$protein','$glukosa_r','$berat_jenis','$ph','$leukosit_s','$eritrosit_s','$epitel','$id_hasil')";
    ...
    if($qry_ur){
        ...
        echo "<script language=\"Javascript\">\n";
        echo "alert('Data Hasil Lab Pemeriksaan Urinalisa Berhasil ditambahkan');";
        echo "</script>";
