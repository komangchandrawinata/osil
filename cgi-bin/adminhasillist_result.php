                ...
                <li class="nav-item">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Rincian Hasil Lab <?php echo $nama_pasien; ?></h1>
                        </div>
                        <br>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <label class="col-sm-7 col-form-label"> : <?php echo TanggalIndo($tgl_hasil);?></label>
                                    ...
                                    <div id="collapse1" class="panel-collapse collapse in ">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <label class="col-sm-3 col-form-label">(juta)</label>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <label class="col-sm-3 col-form-label">(10³/μl)</label>
                                            </div>
                                            ...
                                            <div class="row">
                                                <label class="col-sm-3 col-form-label">- Staf</label>
                                                <div class="form-group col-lg-6">
                                    ...
                                    <div id="collapse3" class="panel-collapse collapse in">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-6">
                                                    <input type="text" class="form-control form-control-user"  value="<?php echo $dt_ba['pmm']; ?>" disabled>
                                                </div>
                                            </div>
