                ...
                <li class="nav-item">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-2">
                            <h1 class="h3 mb-0 text-gray-800">Input Hasil Lab Pemeriksaan Urinalisa <?php echo $nama_pasien; ?></h1>
                        </div>
                            ...
                            <div class="card-body shadow mb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <select class="form-control form-control-user" name="warna">
                                            <option value="-">--Klik untuk memilih--</option>
                                            <option value="Kuning">Kuning</option>
                                            <option value="Tidak Kuning">Tidak Kuning</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <select class="form-control form-control-user" name="kejernihan">
                                            <option value="-">--Klik untuk memilih--</option>
                                            <option value="Jernih">Jernih</option>
                                            <option value="Tidak Jernih">Tidak Jernih</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <select class="form-control form-control-user" name="leukosit_u">
                                            <option value="-">--Klik untuk memilih--</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <select class="form-control form-control-user" name="keton">
                                            <option value="-">--Klik untuk memilih--</option>
                                            <option value="Negatif">Negatif</option>
                                            <option value="Positif">Positif</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <select class="form-control form-control-user" name="nitrit">
                                            <option value="-">--Klik untuk memilih--</option>
                                            <option value="Negatif">Negatif</option>
                                            <option value="Positif">Positif</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <select class="form-control form-control-user" name="urobilinogen">
                                            <option value="-">--Klik untuk memilih--</option>
                                            <option value="Negatif">Negatif</option>
                                            <option value="Positif">Positif</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <select class="form-control form-control-user"  name="bilirubin">
                                            <option value="-">--Klik untuk memilih--</option>
                                            <option value="Negatif">Negatif</option>
                                            <option value="Positif">Positif</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <select class="form-control form-control-user"  name="protein">
                                            <option value="-">--Klik untuk memilih--</option>
                                            <option value="Negatif">Negatif</option>
                                            <option value="Positif">Positif</option>
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <select class="form-control form-control-user"  name="glukosa_r">
                                            <option value="-">--Klik untuk memilih--</option>
                                            <option value="Negatif">Negatif</option>
                                            <option value="Positif">Positif</option>
                                        </select>
