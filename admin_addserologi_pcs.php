...
if(isset($_POST['submit'])) {
    ...
    $hcg = $_POST['hcg'];
    $igg_dengue = $_POST['igg_dengue'];
    $igm_dengue = $_POST['igm_dengue'];
    $hbsag = $_POST['hbsag'];
    $hiv = $_POST['hiv'];
    $rdt_syphilis = $_POST['rdt_syphilis'];
    $rpr = $_POST['rpr'];
    $hcv = $_POST['hcv'];
    $gol_darah = $_POST['gol_darah'];
    $s_thiphi_o = $_POST['s_thiphi_o'];
    $s_parathipy_ao = $_POST['s_parathipy_ao'];
    $s_parathipy_bo = $_POST['s_parathipy_bo'];
    $s_parathipy_co = $_POST['s_parathipy_co'];
    $s_thiphi_h = $_POST['s_thiphi_h'];
    $s_parathipy_ah = $_POST['s_parathipy_ah'];
    $s_parathipy_bh = $_POST['s_parathipy_bh'];
    $s_parathipy_ch = $_POST['s_parathipy_ch'];
    $igg_covid = $_POST['igg_covid'];
    $igm_covid = $_POST['igm_covid'];
    $agcovid = $_POST['agcovid'];
    $tifoid = $_POST['tifoid'];



    $sq_se= "INSERT INTO imunoserologi (
        id_serologi,hcg,igg_dengue,igm_dengue,hbsag,hiv,rdt_syphilis,rpr,hcv,gol_darah,s_thiphi_o,s_parathipy_ao,s_parathipy_bo,s_parathipy_co,s_thiphi_h,s_parathipy_ah,s_parathipy_bh,s_parathipy_ch,igg_covid,igm_covid,agcovid,tifoid,id_hasil)
    VALUES
    ('','$hcg','$igg_dengue','$igm_dengue','$hbsag','$hiv','$rdt_syphilis','$rpr','$hcv','$gol_darah','$s_thiphi_o','$s_parathipy_ao','$s_parathipy_bo','$s_parathipy_co','$s_thiphi_h','$s_parathipy_ah','$s_parathipy_bh','$s_parathipy_ch','$igg_covid','$igm_covid','$agcovid','$tifoid','$id_hasil')";
    ...
    if($qry_se){
        ...
        echo "<script language=\"Javascript\">\n";
        echo "alert('Data Hasil Lab Pemeriksaan Imunoserologi Berhasil ditambahkan');";
        echo "</script>";
